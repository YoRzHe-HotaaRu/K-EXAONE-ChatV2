    ...
    return (
        ...
        >
            ...
            >
                ...
                <h1 className="text-3xl md:text-4xl font-bold font-[var(--font-display)] mb-2">
            ...
            <motion.p
                ...
                className="text-center text-[var(--foreground-muted)] max-w-md mb-8"
            >
                    ...
                    >
                        <div className="flex items-start gap-3">
                            <div className={cn(
                                ...
                                <suggestion.icon className="w-5 h-5 text-[var(--purple-500)]" />
                            </div>
                            <div className="flex-1 min-w-0">
                                <h3 className="font-medium text-[var(--foreground)] mb-0.5">
                                    {suggestion.title}
                                </h3>
